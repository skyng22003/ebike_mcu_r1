...
motor_init_state_t g_motor_init_state = MOTOR_INIT_GET_MOTOR_ALIVE;
motor_init_state_config_t g_motor_init_state_conf = MOTOR_INIT_CONFIG_SEND_CONFIG;
volatile uint8_t ui8_g_motor_init_status = MOTOR_INIT_STATUS_RESET;
...
void rt_send_tx_package(frame_type_t type) {
  //  Serial.println("SentLoop");
    ...
    {
        //Serial.println("Sent Periodic Packet");
  ...
  if ((g_motor_init_state == MOTOR_INIT_SIMULATING) || p_rx_buffer) {
    ...
    if (p_rx_buffer) {
      ...
      switch (g_motor_init_state) {
        ...
        //  Serial.println("MOTOR_INIT_WAIT_MOTOR_ALIVE");

        case MOTOR_INIT_WAIT_MOTOR_FIRMWARE_VERSION:
          if (ui8_frame == FRAME_TYPE_FIRMWARE_VERSION)
            process_frame = 1;
          //Serial.println("MOTOR_INIT_WAIT_MOTOR_FIRMWARE_VERSION");
          break;
        ...
        case MOTOR_INIT_READY:
            process_frame = 1;
            //Serial.println("MOTOR_INIT_READY");
          break;
      }
      ...
      if (process_frame) {
        switch (ui8_frame) {
          ...
          case FRAME_TYPE_FIRMWARE_VERSION:
          {
             ...
             // Serial.println("MOTOR_INIT_GOT_MOTOR_FIRMWARE_VERSION");
              break;
          }
          }
      }
...
#endif
  {
    ...
    switch (g_motor_init_state) {
      case MOTOR_INIT_GET_MOTOR_ALIVE:
        ...
        //Serial.println("MOTOR_INIT_GET_MOTOR_ALIVE");
      case MOTOR_INIT_WAIT_MOTOR_ALIVE:
        // check timeout
         // Serial.println("MOTOR_INIT_WAIT_MOTOR_ALIVE");
         // Serial.print("Command_error:");
         // Serial.println(ui16_motor_init_command_error_cnt);
      ...
      case MOTOR_INIT_GET_MOTOR_FIRMWARE_VERSION:
        ...
        // not break here to follow for next case
       // Serial.println("MOTOR_INIT_GET_MOTOR_FIRMWARE_VERSION");
      case MOTOR_INIT_WAIT_MOTOR_FIRMWARE_VERSION:
